...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RewriteBlogPost.publish_date'
        db.add_column('rewrite_rewriteblogpost', 'publish_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'RewritePage.publish_date'
        db.add_column('rewrite_rewritepage', 'publish_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RewriteBlogPost.publish_date'
        db.delete_column('rewrite_rewriteblogpost', 'publish_date')

        # Deleting field 'RewritePage.publish_date'
        db.delete_column('rewrite_rewritepage', 'publish_date')
