...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RewriteSection.is_blog_section'
        db.add_column('rewrite_rewritesection', 'is_blog_section', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RewriteSection.is_blog_section'
        db.delete_column('rewrite_rewritesection', 'is_blog_section')
    ...
    models = {
        ...
        'rewrite.rewritesection': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_blog_section': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
