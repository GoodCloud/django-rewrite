...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RewriteBlogPost.template'
        db.delete_column('rewrite_rewriteblogpost', 'template_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'RewriteBlogPost.template'
        raise RuntimeError("Cannot reverse this migration. 'RewriteBlogPost.template' and its values cannot be restored.")
