...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RewriteBlogPost.website'
        db.add_column('rewrite_rewriteblogpost', 'website', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rewrite.RewriteWebsite']), keep_default=False)

        # Adding field 'RewritePage.website'
        db.add_column('rewrite_rewritepage', 'website', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rewrite.RewriteWebsite']), keep_default=False)

        # Adding field 'RewriteBlog.website'
        db.add_column('rewrite_rewriteblog', 'website', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rewrite.RewriteWebsite']), keep_default=False)

        # Adding field 'RewriteSection.website'
        db.add_column('rewrite_rewritesection', 'website', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rewrite.RewriteWebsite']), keep_default=False)

        # Adding field 'RewriteTemplate.website'
        db.add_column('rewrite_rewritetemplate', 'website', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rewrite.RewriteWebsite']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RewriteBlogPost.website'
        db.delete_column('rewrite_rewriteblogpost', 'website_id')

        # Deleting field 'RewritePage.website'
        db.delete_column('rewrite_rewritepage', 'website_id')

        # Deleting field 'RewriteBlog.website'
        db.delete_column('rewrite_rewriteblog', 'website_id')

        # Deleting field 'RewriteSection.website'
        db.delete_column('rewrite_rewritesection', 'website_id')

        # Deleting field 'RewriteTemplate.website'
        db.delete_column('rewrite_rewritetemplate', 'website_id')
