...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RewriteSection.slug'
        db.add_column('rewrite_rewritesection', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RewriteSection.slug'
        db.delete_column('rewrite_rewritesection', 'slug')
