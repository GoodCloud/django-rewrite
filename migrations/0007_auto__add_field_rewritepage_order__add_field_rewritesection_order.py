...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RewritePage.order'
        db.add_column('rewrite_rewritepage', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'RewriteSection.order'
        db.add_column('rewrite_rewritesection', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RewritePage.order'
        db.delete_column('rewrite_rewritepage', 'order')

        # Deleting field 'RewriteSection.order'
        db.delete_column('rewrite_rewritesection', 'order')
